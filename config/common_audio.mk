...
ALARM_PATH := vendor/aosop/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/aosop/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/aosop/prebuilt/common/media/audio/ringtones
